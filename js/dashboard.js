...
import { AllianceView } from "./views/AllianceView.js";
import { CoordinatesController } from "./controllers/CoordinatesController.js";
import { DEFAULT_AVATAR, LEVEL_ICON, LEVEL_ICON_ALLIANCE, STARBASE_ICON, BUDDYBOT_LOGO, SOLAR_SYSTEMS } from "./utils/Constants.js";
        ...
        // RENDERIZAR ALIANZAS
            ...
            results.forEach(alliance => {
                ...
                card.addEventListener("click", () => {
                    ...
                    AllianceView.load(alliance.Name);
                });
                resultsGrid.appendChild(card);
            });
        }
